...
class Styles {
  ...
  static const TextStyle txtGeneralWhiteSmall =
      TextStyle(fontFamily: 'Poppins', fontSize: 10, color: Colors.white);
  ...
  static const TextStyle txtGeneralTitleWhite =
      TextStyle(fontFamily: 'Poppins', fontSize: 16, color: Colors.white);

  static const TextStyle txtGeneralTitleBlack =
      TextStyle(fontFamily: 'Poppins', fontSize: 16, color: Color(0xFF302B27));
}
